...
class TestBigQueryWriter:
    ...
    def test_bq_get_correct_schema(self, bq_writer, sample_data):
        ...
        assert schema == [
            bigquery.SchemaField('column_1', 'INT64', 'NULLABLE', None, None,
                                 (), None),
            bigquery.SchemaField('column_2', 'STRING', 'NULLABLE', None, None,
                                 (), None),
            bigquery.SchemaField('column_3', 'INT64', 'REPEATED', None, None,
                                 (), None),
        ]

    def test_bq_get_correct_schema_with_dates(self, bq_writer,
                                              sample_data_with_dates):
        schema = bq_writer._define_schema(sample_data_with_dates)
        assert schema == [
            bigquery.SchemaField('column_1', 'INT64', 'NULLABLE', None, None,
                                 (), None),
            bigquery.SchemaField('datetime', 'DATETIME', 'NULLABLE', None, None,
                                 (), None),
            bigquery.SchemaField('date', 'DATE', 'NULLABLE', None, None, (),
                                 None),
        ]
